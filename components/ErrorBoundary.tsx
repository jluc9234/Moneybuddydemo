...
// Fix: Renamed Props to ErrorBoundaryProps to be more specific and avoid potential name collisions.
interface ErrorBoundaryProps {
  children: ReactNode;
}

// Fix: Renamed State to ErrorBoundaryState to be more specific and avoid potential name collisions.
